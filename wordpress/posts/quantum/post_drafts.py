...
POSTS = [
    dict(
        ...
        excerpt=u'NECが実機の開発を取りやめたと報じられました。'
                u'量子ビットが持つ「矢印」とは何か、なぜ普通のコンピュータでは'
                u'追いつけないのか。わかりやすさのために事実を曲げずに、'
                u'仕組みと原理をご説明します。',
        featured=1,
        images=[
        ...
        links=[(u'<li>量子コンピュータとは何か【後編】いまどこまで来ているのか（近日公開）</li>',
                u'<li><a href="%s/quantum-computer-02-status/">'
                u'量子コンピュータとは何か【後編】いまどこまで来ているのか</a></li>' % SITE)],
    ),
    dict(
        file='article-02.html',
        slug='quantum-computer-02-status',
        title=u'量子コンピュータとは何か【後編】いまどこまで来ているのか',
